 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://service.employeeservice.web_services.anonbnr.org/", wsdlLocation = "http://localhost:8080/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://service.employeeservice.web_services.anonbnr.org/", "EmployeeServiceImplService");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://service.employeeservice.web_services.anonbnr.org/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.employeeservice.web_services.anonbnr.org/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }
