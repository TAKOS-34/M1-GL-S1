...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr quatre = new UPPCte(4);
        UPPExpr new_arr = new UPPAdd(this.arr.toUPP(locals), new UPPMul(quatre, this.index.toUPP(locals)));

        return new UPPLoad(new_arr);
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        return new UPPSet(new_arr, this.val.toUPP(locals));
    }//toUPP
...
class PPWhile extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        return new UPPWhile(this.cond.toUPP(locals), this.i.toUPP(locals));
    }//toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        ArrayList<UPPExpr> transactions = new ArrayList<>();
        for (PPExpr expr : args) {
            transactions.add(expr.toUPP(locals));
        }

        return new UPPProcCall(this.callee, transactions);
    }//toUPP
